  ...
  function registerUser() {
    ...
    axios
      ...
      .then(function (response) {
        if (response.data === false) Alert.alert("이미 등록된 유저입니다.")
        else {
      ...
      <View style={$profileBox}>
        <View style={$screenContentContainer}>
          ...
          <View style={$buttonField}>
            <Button text="취소" style={$tapButtonBack} onPress={returnLogin} />
            <Button text="완료" style={$tapButtonSignup} onPress={registerUser} />
          </View>
        </View>
      </View>
    </ImageBackground>
